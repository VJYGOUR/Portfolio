...
function SocialLink({ clr }) {
  return (
    <div className="flex gap-4 ">
      <Link to="https://github.com/VJYGOUR">
      ...
      <Link to="https://twitter.com/Vijay_kumar1212">
      ...
      <Link to="https://www.linkedin.com/in/vijay-sharma-639311212/">
